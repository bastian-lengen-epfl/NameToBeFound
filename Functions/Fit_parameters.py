...
PL_break = True             # Allows for a break in the PLR at P=10d
...
### SNe
a_b = 0.715840              # Value for the Hubble diagram's intercept
sigma_a_b = 0.001631        # 0.71273 +/- 0.00176 Riess 2016, OR can be fitted
